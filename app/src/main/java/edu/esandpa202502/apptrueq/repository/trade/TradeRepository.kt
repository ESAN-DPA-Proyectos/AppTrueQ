...
class TradeRepository {
     ...
     * Esta es la forma correcta, el repositorio se encarga de la lógica de creación.
     */
    suspend fun createTradeFromProposal(proposal: Proposal, receiverName: String): String {
        val newTrade = Trade(
            ...
            // Se usa un String simple para el estado, como está definido en el modelo Trade.kt
            status = "Aceptado"
        )
